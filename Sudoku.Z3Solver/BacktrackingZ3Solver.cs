...
public class BacktrackingZ3Solver : ISudokuSolver
{
    public SudokuGrid Solve(SudokuGrid s)
    {
        using (Context ctx = new Context())
        {
            ...
            //contrainte chaque chiffre different sur une ligne 
            ...
            //contrainte chaque chiffre different sur une colonne 
            ...
            //contrainte pour fixer les éléments initaux de la grille
